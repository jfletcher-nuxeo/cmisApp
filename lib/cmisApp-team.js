...
function fillClaimList(queryResults) {
    var claimListHeaders = "";

    // Headers
    claimListHeaders = claimListHeaders + createClaimListHeader("Incident ID");
    claimListHeaders = claimListHeaders + createClaimListHeader("First Name");
    claimListHeaders = claimListHeaders + createClaimListHeader("Last Name");
    claimListHeaders = claimListHeaders + createClaimListHeader("State");
    claimListHeaders = claimListHeaders + createClaimListHeader("Report");

    document.getElementById("claimListHeader").innerHTML = claimListHeaders;
...
/******************************************************************************
 * Create claim list header cell.
 *****************************************************************************/
function createClaimListHeader(cellData) {
    var tableHeader = "<th class=\"claimListHeaderCell\">" + cellData + "</th>";
    return tableHeader;
}
